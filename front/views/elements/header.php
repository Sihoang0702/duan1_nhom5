...
<head>
	...
	<link rel="stylesheet" type="text/css" href="css/styles/main_style.css">
		...
		<header class="header trans_300">
			...
			<div class="top_nav">
				<div class="container">
					<div class="row">
						<div class="col-md-6">
							<div class="top_nav_left">Miễn Phí Giao Hàng Với Đơn Hàng Trên 1 Triệu</div>
						</div>
								...
								<ul class="top_nav_menu">
									...
									<li class="account">
										...
										<ul class="account_selection">
											<li><a href="views/elements/login.php"><i class="fa fa-sign-in" aria-hidden="true"></i>Đăng Nhập</a></li>
						...
						<div class="col-lg-12 text-right">
							...
							<nav class="navbar">
								<ul class="navbar_menu">
									...
									<li><a href="../front/views/products/categories.php">shop</a></li>
									<li><a href="#">pages</a></li>
									<li><a href="../front/views/products/contact.php">Liên Hệ</a></li>
								...
								<ul class="navbar_user">
									...
									<li class="checkout">
										<a href="../front/views/products/cart.php">
