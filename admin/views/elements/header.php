            ...
            <div class="col-md-3 left_col">
                            ...
                            <ul class="nav side-menu">
                                <li><a><i class="fa fa-home"></i> Home <span class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu">
                                        <li><a href="../front/index.php">Trang chủ</a></li>
                                        <li><a href="../front/views/products/categories.php">Sản phẩm</a></li>
                                ...
                                <li><a><i class="fa fa-edit"></i> Quản Lý<span class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu">
                                        ...
                                        <li><a href="index.php?act=dskh">Quản lý người dùng</a></li>
                ...
                <li> <a href="index.php?act=thongke">Thống kê </a></li>
                    ...
                    <div class="sidebar-footer hidden-small">
                        ...
                        <a data-toggle="tooltip" data-placement="top" title="Logout" href="../front/views/elements/login.php">
                        ...
                        <ul class=" navbar-right">
                            <li class="nav-item dropdown open" style="padding-left: 15px;">
                                ...
                                <div class="dropdown-menu dropdown-usermenu pull-right" aria-labelledby="navbarDropdown">
                                    ...
                                    <a class="dropdown-item" href="../front/views/elements/login.php"><i class="fa fa-sign-out pull-right"></i>
